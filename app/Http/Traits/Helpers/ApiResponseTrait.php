...
trait ApiResponseTrait
{
    ...
    public function parseGivenData($data = [], $statusCode = 200, $headers = [])
    {
        ...
        $responseStructure['code'] = $statusCode;
    ...
    {
        return $this->apiResponse(['status' => 'success', 'message' => $message]);
    }
    ...
    {
        return $this->apiResponse(['status' => 'success', 'message' => $message], 200);
    }
    ...
    {
        return $this->respondWithResource(array(), $message);
    }
    /**
     * Respond with no content.
     *
    ...
    {
        return $this->respondWithResourceCollection(array(), $message);
    }
     ...
     * @return JsonResponse
     */
    protected function respondError($message = '', $result = array(), int $statusCode = 400, Exception $exception = null, int $error_code = 1)
    {
